package cn.eas.usdk.demo.mymobile;
...
public class MobileMoneyActivity extends BaseDeviceActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState) {
        ...
        setTitle("Mobile Money Transaction");
    ...
    public void sendEcoSV(View v) {
        outputBlueText(">>> sending eco trans to SV");
    ...
    public void sendDirect(View v) {
        outputBlueText(">>> sending the trans to ecocash ");
        try {
